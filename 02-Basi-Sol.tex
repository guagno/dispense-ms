%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Soluzione degli esercizi del Capitolo \ref{cap:basi}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Esercizio \ref{ex2:relaSOmega}}
\addcontentsline{toc}{section}{Esercizio \ref{ex2:relaSOmega}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\addcontentsline{toc}{section}{Esercizio \ref{ex2:sfere}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}[scale=0.5]
  ...
  %\draw[thick] (0,0) arc[start angle=0, end angle=360, x radius=2, y radius=2];
  %\draw[thick] (4,0) arc[start angle=0, end angle=360, x radius=2, y radius=2];
  \draw[thick,red,dotted] (0,0) circle (4);
  %\draw[thick,dotted] (2,0) arc[start angle=0, end angle=360, x radius=4, y radius=4];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Esercizio \ref{ex2:Saddit}}
\addcontentsline{toc}{section}{Esercizio \ref{ex2:Saddit}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
